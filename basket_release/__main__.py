...
def main() -> int:
    ...
    if args.command in {"source-probe","source-lock"}:
        ...
        release,bundle=build_v2(args.source_lock,args.price_release,args.output,args.integration_output); result={"release":str(release),"integration_bundle":str(bundle)}
